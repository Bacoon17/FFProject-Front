...
// Importation des données (ici en dur)
...
// Fonction principale d'affichage du tableau dans sa globalité
...
export default function CustomPaginationActionsTable() {
    ...
    // Constante qui permet de connaitre le nombre de lignes vides à la dernière page
