                ...
                >
                    ...
                    <DialogContent>
                        <form style = {{width: 500}} noValidate autoComplete="off">
                            <div><TextField style = {{width: 500, margin: 5,}} id="outlined-basic" label="Personnage" variant="outlined" /></div>
                            <div><TextField style = {{width: 500, margin: 5,}} id="outlined-basic" label="Episode" variant="outlined" /></div>
                            <div><TextField style = {{width: 500, margin: 5,}} id="outlined-basic" label="Cristal" variant="outlined" /></div>
                            <div><TextField style = {{width: 500, margin: 5,}} id="outlined-basic" label="Weapon" variant="outlined" /></div>
                            <div><TextField style = {{width: 500, margin: 5,}} id="outlined-basic" label="Voice" variant="outlined" /></div>
                        </form>
                    </DialogContent>
                    
                    <DialogActions>
                        <Button onSubmit={this.handleValidate} color="primary">Valider</Button>
                    </DialogActions>
                </Dialog>
            </>
        )
